           ...
           <h1 className="font-display text-4xl md:text-5xl mb-4 leading-tight">
            ...
            <p className="font-body text-sm text-muted-foreground mt-2">
             ...
             <a
              ...
              target="_blank"> Get the <strong>FREE Mini Pack →</strong></a>
            </p>
          </div>
    ...
    <section className="py-16 md:py-24 bg-card">
      <div className="container max-w-2xl text-center">
        ...
        <p className="font-body text-muted-foreground mb-8">
          The guide includes a full safety page so you always know what's safe and what to avoid.
        </p>
        <div className="rounded-2xl border p-6 text-left space-y-3">
          <p className="font-body text-sm"><strong>Treats = max 10%</strong> of your dog's daily food.</p>
          <p className="font-body text-sm"><strong>Start small:</strong> try 1 new treat and wait 24 hours.</p>
          <p className="font-body text-sm"><strong>Never use:</strong> xylitol, chocolate, grapes/raisins, macadamia nuts, onion, garlic, alcohol, cooked bones, or high-salt seasonings.</p>
          <p className="font-body text-sm"><strong>High-risk dogs:</strong> pancreatitis, kidney disease, allergies → ask your vet first.</p>
          <p className="font-body text-sm text-muted-foreground italic">If it smells off, feels slimy, or grows mold — throw it out.</p>
        </div>
      </div>
    </section>
        ...
        <div className="space-y-4">
          {faqs.map((faq, i) => (
            <div key={i} className="rounded-2xl bg-card border p-6">
              <h3 className="font-subhead text-lg mb-2">{faq.q}</h3>
