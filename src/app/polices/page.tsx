    ...
    <section className="py-20 md:py-28">
      <div className="container max-w-3xl">
        ...
        <Accordion type="multiple" className="space-y-4 mb-12">
          ...
          {/* HOURS & PICK-UP WINDOWS */}
           <AccordionItem value="hours" className="rounded-2xl bg-card border px-6">
            ...
            <AccordionContent className="font-body text-sm text-muted-foreground space-y-4">
              ...
              <ul className="list-disc pl-5 space-y-1">
                <li><span className="text-[color:var(--foreground)] font-medium">Regular Operating Hours:</span> 6:00 AM – 6:00 PM</li>
                <li><span className="text-[color:var(--foreground)] font-medium">Late Pick-Up (By Approval Only):</span> Up to 10:00 PM (extended time varies by service — see details below).</li>
              </ul>

              <h4 className="font-subhead text-[color:var(--foreground)] text-base">Extended Time — Approval Only (Latest Pick-up: 10:00 PM)</h4>
              <p>Extended Time is optional and must be requested and approved in advance. Pick-ups can never be later than 10:00 PM.</p>

              <h4 className="font-subhead text-[color:var(--foreground)] text-base">Daycare</h4>
              <ul className="list-disc pl-5 space-y-1">
              ...
              <h4 className="font-subhead text-[color:var(--foreground)] text-base">Boarding (24-Hour Blocks)</h4>
              ...
              <h4 className="font-subhead text-[color:var(--foreground)] text-base">Extended Time Limits (Boarding)</h4>
              ...
              <h4 className="font-subhead text-[color:var(--foreground)] text-base">Important Notes</h4>
              <ul className="list-disc pl-5 space-y-1">
              ...
              <h4 className="font-subhead text-[color:var(--foreground)] text-base">No Unapproved Late Pick-Ups</h4>
              ...
              <h4 className="font-subhead text-[color:var(--foreground)] text-base">10:00 PM Cutoff (Strict)</h4>
          ...
          <AccordionItem value="health" className="rounded-2xl bg-card border px-6">
            ...
            <AccordionContent className="font-body text-sm text-muted-foreground space-y-4">
              ...
              <h4 className="font-subhead text-[color:var(--foreground)] text-base">Why We Require Records</h4>
              <ul className="list-disc pl-5 space-y-1">
                <li><span className="text-[color:var(--foreground)] font-medium">Disease prevention:</span> Vaccines reduce the risk of contagious illnesses in group settings.</li>
                <li><span className="text-[color:var(--foreground)] font-medium">Protects vulnerable pups:</span> Puppies, seniors, and immunocompromised dogs depend on community immunity.</li>
                <li><span className="text-[color:var(--foreground)] font-medium">Faster check-in:</span> Records on file prevent delays at drop-off and help us respond quickly in emergencies.</li>
                <li><span className="text-[color:var(--foreground)] font-medium">Vet consistency:</span> Records include due dates so we can flag expiring vaccines.</li>
              </ul>

              <h4 className="font-subhead text-[color:var(--foreground)] text-base">Minimum Required Vaccines</h4>
              <ul className="list-disc pl-5 space-y-1">
              ...
              <h4 className="font-subhead text-[color:var(--foreground)] text-base">Strongly Recommended</h4>
              <ul className="list-disc pl-5 space-y-1">
              ...
              <h4 className="font-subhead text-[color:var(--foreground)] text-base">What the Record Should Show</h4>
              <ul className="list-disc pl-5 space-y-1">
              ...
              <h4 className="font-subhead text-[color:var(--foreground)] text-base">How to Send Records (Digital Only)</h4>
              <ul className="list-disc pl-5 space-y-1">
                <li>Text or WhatsApp: <span className="text-[color:var(--foreground)] font-medium">(818) 697-3791</span></li>
              ...
              <h4 className="font-subhead text-[color:var(--foreground)] text-base">Nail Care for Safe Play</h4>
              ...
              <h4 className="font-subhead text-[color:var(--foreground)] text-base">Privacy</h4>
          ...
          <AccordionItem value="payment" className="rounded-2xl bg-card border px-6">
            ...
            <AccordionContent className="font-body text-sm text-muted-foreground space-y-4">
              ...
              <h4 className="font-subhead text-[color:var(--foreground)] text-base">New Clients</h4>
              <ul className="list-disc pl-5 space-y-1">
                <li>Stays ≤ $200 → 50% at booking, balance at pick-up.</li>
                <li>Stays &gt; $200 → 100% due before check-in.</li>
              </ul>

              <h4 className="font-subhead text-[color:var(--foreground)] text-base">Existing Clients</h4>
              ...
              <p className="text-[color:var(--foreground)] font-medium">Bookings are not confirmed until deposit/payment is received.</p>
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="cancellations" className="rounded-2xl bg-card border px-6">
            ...
            <AccordionContent className="font-body text-sm text-muted-foreground space-y-4">
              ...
              <h4 className="font-subhead text-[color:var(--foreground)] text-base">Non-Holiday / Non-Peak Dates</h4>
              <ul className="list-disc pl-5 space-y-1">
                <li>Cancel or reschedule at least <span className="text-[color:var(--foreground)] font-medium">48 hours (2 days)</span> before check-in to avoid fees.</li>
                <li>Cancellations within 48 hours may result in a cancellation fee of <span className="text-[color:var(--foreground)] font-medium">$50</span>.</li>
              </ul>

              <h4 className="font-subhead text-[color:var(--foreground)] text-base">Holiday / Peak Dates</h4>
              <ul className="list-disc pl-5 space-y-1">
                <li>Cancel at least <span className="text-[color:var(--foreground)] font-medium">72 hours (3 days)</span> before check-in to avoid fees.</li>
                <li>Cancellations within 72 hours may result in a cancellation fee of <span className="text-[color:var(--foreground)] font-medium">$100</span>.</li>
              </ul>

              <h4 className="font-subhead text-[color:var(--foreground)] text-base">No-Shows</h4>
              ...
              <h4 className="font-subhead text-[color:var(--foreground)] text-base">Early Pick-Up / Early Return</h4>
        ...
        <div className="text-center space-y-4">
          <a
            href="/Cousin_Haven_Policy_Requirements.pdf"
            download
